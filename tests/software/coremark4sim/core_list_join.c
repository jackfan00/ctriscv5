...
ee_u16 core_bench_list(core_results *res, ee_s16 finder_idx) {
	...
	ee_s16 i;
        ...
        //volatile int * coremark_debug;
        //coremark_debug = (int *)0x10001400;
        //*coremark_debug = 0x1234;
        //ee_printf("find_num=%d list=%x listinfo=%x\n", find_num, list, list->info);
        //ee_printf("find_num=%d list=%x listinfo=%x\n", find_num, list, list->info->data16);
        //ee_printf("find_num=%d list=%x\n", find_num, list );
